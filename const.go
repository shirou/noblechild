...
var (
	...
	attrPrimaryServiceUUID   = gatt.UUID16(0x2800)
	attrSecondaryServiceUUID = gatt.UUID16(0x2801)
	attrIncludeUUID          = gatt.UUID16(0x2802)
	attrCharacteristicUUID   = gatt.UUID16(0x2803)

	attrClientCharacteristicConfigUUID = gatt.UUID16(0x2902)
	attrServerCharacteristicConfigUUID = gatt.UUID16(0x2903)
